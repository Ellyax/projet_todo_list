...
<body>
<!-- génération de la barre de navigation en haut de notre site -->
<nav class="navbar navbar-default">
	<div style="background: #C7C4C4;">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand">Projet Todo_list</a>
			</div>

			<!-- Collect the nav links, forms, and other content for toggling -->
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<li> <!--class="active" --> <a href={{URL::to('/')}}>Ajouter une nouvelle tâche<span class="sr-only">(current)</span></a></li>
					<li><a href={{URL::to('/list')}}>Voir mes tâches</a></li>
					<li><a href={{URL::to('/about')}}>À propos</a></li>
